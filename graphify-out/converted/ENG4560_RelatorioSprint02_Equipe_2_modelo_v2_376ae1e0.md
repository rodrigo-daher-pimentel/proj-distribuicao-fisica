<!-- converted from ENG4560_RelatorioSprint02_Equipe_2_modelo_v2.docx -->
...
# 12 Códigos Python
Os notebooks descritos na Seção 5.2 — Aulas/2 (preparação), Aulas/3 e Aulas/4 (MILP), Aulas/7 (heurísticas construtivas) e Aulas/8 (busca local) — concentram a totalidade do código entregue nas Sprints 1 e 2. As soluções refinadas pela busca local estão persistidas em arquivos JSON na pasta Aulas/8/Aula8_Busca_Local/files/ e servem como ponto de partida para as metaheurísticas da Sprint 3. A reprodutibilidade é garantida pela seed fixa (42), versão do Gurobi (13.0.1) e bloco da equipe (EQUIPE_ID = 2) declarados em todos os notebooks.
...
| 2010762 | Bernardo Caula | Marcello Congro |
| 2010767 | João Felipe Leal |  |
| 2010798 | Lucas Campos |  |
| 2010800 | Lucas Terzi |  |
| 2010834 | Rodrigo Pimentel |  |
| Rio de Janeiro
